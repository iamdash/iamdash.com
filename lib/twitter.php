...
class Twitter{
    ...
    private function _parseTweets($tweet) {
        ...
        #foreach($tweets as $tweet){
            ...
            $t['text_parsed'] = preg_replace("/>(([[:alnum:]]+:\/\/)|www\.)([^[:space:]]".
                    ...
                    "</", ">\\3...\\5\\6<", $t['text_parsed']);
            #$parsed_tweets['count']     =   $i;
            #$parsed_tweets['created']   = strtotime($t['created_at']);
            #$parsed_tweets['tweet']     = preg_replace('/%u([a-fA-F0-9]{4})/', '&#x\\1;', $t['text_parsed']);
            #$parsed_tweets['username']  = $this->username;
            $i++;
        #}

        return $t['text_parsed'];
    }
}